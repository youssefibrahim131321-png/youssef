  ...
  async function mountNotifyBanner(user) {
    ...
    style.textContent = `
      #notifyBanner{position:fixed;bottom:18px;inset-inline:18px;z-index:400;max-width:460px;margin-inline-start:auto;
        ...
        background:linear-gradient(135deg, rgba(47, 111, 98,.16), rgba(200, 121, 63,.12));
      ...
      #notifyBannerEnable{background:linear-gradient(135deg,#c8793f,#e0a15c);color:#1a1206;border:none;border-radius:12px;padding:9px 14px;font-weight:800;font-size:13px;cursor:pointer;font-family:inherit;}
