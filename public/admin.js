...
function drawChart(series) {
  ...
  $('#salesChart').innerHTML = `
    <defs><linearGradient id="g1" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#ce7c3e" stop-opacity=".35"/><stop offset="100%" stop-color="#ce7c3e" stop-opacity="0"/>
    </linearGradient></defs>
    ${grid}
    <path d="${area}" fill="url(#g1)"/>
    <path d="${line}" fill="none" stroke="#ce7c3e" stroke-width="2.5" stroke-linejoin="round" stroke-linecap="round"/>
...
const STATUS_COLORS = { pending: '#ce7c3e', confirmed: '#5a8fb0', shipping: '#3f8f7d', done: '#3ecf8e', cancelled: '#e5483c' };
